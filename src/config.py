...
# OAuth 2.0 Client Settings
AUTH_CONFIG = {
    'OAUTH_CLIENT_ID': '958030220265-bopu4k7bosf0fe2lcoprjte6up03ga1o.apps.googleusercontent.com',
    'OAUTH_CLIENT_SECRET': '5JYotmz22SraYRZQA1nDuaDf',

    # E.g. Local Dev Env on port 8080: http://localhost:8080
    # E.g. Hosted on App Engine: https://your-application-id.appspot.com
    'OAUTH_REDIRECT_URI': '%s%s' % (
        'https://fvcproductions-analytics.appspot.com',
        '/admin/auth')
}
